function task3_full_sim3()

% Task 3: Hui-type high school building fire inspection (3 responders)

clc; close all;
fprintf('\n=== Task 3 Simulation: Hui-type High School Building (3 firefighters) ===\n');
