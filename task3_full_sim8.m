function task3_full_sim8()

% Task 3: Hui-type high school building fire inspection (8 responders)

clc; close all;
fprintf('\n=== Task 3 Simulation: Hui-type High School Building (8 firefighters) ===\n');
...
startPos(5) = 0;
startPos(6) = Lcorridor; 
startPos(7) = 0;
startPos(8) = Lcorridor; 
