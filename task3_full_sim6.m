function task3_full_sim6()

% Task 3: Hui-type high school building fire inspection (6 responders)

clc; close all;
fprintf('\n=== Task 3 Simulation: Hui-type High School Building (6 firefighters) ===\n');
