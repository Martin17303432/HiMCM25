function task_full_sim4()

% Task 3: Hui-type high school building fire inspection (4 responders)

clc; close all;
fprintf('\n=== Task 3 Simulation: Hui-type High School Building (4 firefighters) ===\n');
...
assignF = cell(x,1);
assignF{1} = [9 1 2 3 4 ]
assignF{2} = [10 5 6 7 8 ];
assignF{3} = [9 1 2 3 4 ];
assignF{4} = [10 5 6 7 8 ];
theta = theta_fun(x);
delta = delta_fun(x,m);
