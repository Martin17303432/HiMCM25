function task3_full_sim7()

% Task 3: Hui-type high school building fire inspection (7 responders)

clc; close all;
fprintf('\n=== Task 3 Simulation: Hui-type High School Building (7 firefighters) ===\n');
